...
export const CommandKModal: React.FC<CommandKModalProps> = ({
  ...
  const allNavItems = useMemo(() => {
    ...
    const extraTools = [
      ...
      { id: "calculators", subTab: "cagr", label: "CAGR Compound Annual Growth Calculator", group: "Financial Calculators", icon: null },
      { id: "calculators", subTab: "fire", label: "Retirement Shortfall (FIRE) Calculator", group: "Financial Calculators", icon: null },
      { id: "calculators", subTab: "fdrd", label: "FD & RD Maturity Calculator", group: "Financial Calculators", icon: null },
      { id: "calculators", subTab: "loan-invest", label: "Loan vs Invest Advisor (Prepay vs Reinvest)", group: "Financial Calculators", icon: null },
      { id: "calculators", subTab: "projection", label: "Wealth & Net Worth Projection", group: "Financial Calculators", icon: null },
      { id: "calculators", subTab: "stress", label: "Runway Stress Tester & Crisis Simulator", group: "Financial Calculators", icon: null },
      { id: "calculators", subTab: "monte-carlo", label: "Monte Carlo Retirement Simulator", group: "Financial Calculators", icon: null },
      { id: "calculators", subTab: "scenario-sandbox", label: "Scenario Sandbox & Lifestyle Planner", group: "Financial Calculators", icon: null },
      { id: "calculators", subTab: "indexation", label: "Indexation Benefit & CII Capital Gains Calculator", group: "Financial Calculators", icon: null },
      { id: "calculators", subTab: "retirement-income", label: "Retirement Income & Multi-Source Cashflow Planner", group: "Financial Calculators", icon: null },
